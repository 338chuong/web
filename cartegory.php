  ...
  <div class="cartegory">
    ...
    <div class="cartegory-left">
      <ul>
          ...
          <li><a href=""><i class="fa-solid fa-caret-right"></i> Thời Trang Nam</a>
            <ul>
    ...
    <div class="cartegory-right">
        ...
        <div class="cartegory-right-bottom cartegory">
          <div class="cartegory-right-bottom-item">
            ...
            <div>
              <a href="product.php">Áo khoác nam cổ cao</a>
              <p>110.000<sup>đ</sup> - 150.000<sup>đ</sup></p>
            </div>
            </div>
          <div class="cartegory-right-bottom-item">
            <img src="img/b2.jfif" alt="">
            <div>
              <a href="aokhoac.php">Áo thun tia sét,Cotton co dãn</a>
          ...
          <div class="cartegory-right-bottom-item ">
            ...
            <div>
              <a href="ao.php">Áo sweater nam</a>
              <p>129.000<sup>đ</sup><p>
            </div>
          </div>
          <div class="cartegory-right-bottom-item ">
            <img src="img/b4.jfif" alt="">
            <div>
              <a href="aohodienam.php">Áo hoodie nam nữ</a>
    ...
    <div class="cartegory-bottom" style="text-align: center; margin-top: 20px;">
      <button style="background-color: white;">&#10510;</button>
      <button style="background-color: red;color: white;border-radius: 3px;">1</button>
      <button style="background-color: white"><a href="cartegory1.php" style="color: black;text-decoration: none;">2</a></button>
      <span style="background-color: white; margin-left: 10px;">...</span>
      <button style="background-color: white;"><a href="cartegory1.php" style="color: black; text-decoration: none;">&#10511;</a></button>
    </div>
  </div>
</section>
