...
<section>
  <div class="cartegory">
    ...
    <div class="cartegory-bottom">
      <button style="background-color: white;"><a href="cartegory.php" style="color: black; text-decoration: none;">&#10510;</a></button>
      <button style="background-color: white;"><a href="cartegory.php" style="color: black; text-decoration: none;">1</a></button>
      <button style="background-color: red;color: white;border-radius: 3px; ">2</button>
