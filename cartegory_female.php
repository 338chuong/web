  ...
  <div class="cartegory">
    ...
    <div class="cartegory-left">
      <ul>
          ...
          <li><a href=""><i class="fa-solid fa-caret-right"></i> Thời Trang Nữ</a>
            <ul>
              <li><a href="product.php">Áo Khoác</a></li>
    ...
    <div class="cartegory-right">
        ...
        <div class="cartegory-right-bottom cartegory">
          <div class="cartegory-right-bottom-item">
            <img style="height: 70%;" src="img/female/1/product_1.jpg" alt="">
            <div>
              <a href="">Áo ngủ nữ</a>
          ...
          <div class="cartegory-right-bottom-item">
            <img style="height: 70%;" src="img/female/1/product_2.jpg" alt="">
            <div>
              <a href="">Áo len mùa đông </a>
              <p>14.000<sup>đ</sup> - 50.000<sup>đ</sup></p>
            </div>
          </div>
          <div class="cartegory-right-bottom-item ">
            <img style="height: 70%;" src="img/female/1/product_3.jpg" alt="">
            <div>
              <a href="">Áo sơ mi tay ngắn nữ</a>
              <p>129.000<sup>đ</sup><p>
            </div>
          </div>
          <div class="cartegory-right-bottom-item ">
            <img style="height: 70%;" src="img/female/1/product_4.jpg" alt="">
            <div>
              <a href="">Quần âu nữ ống xuông</a>
              <p>140.000<sup></sup> - 150.000<sup>đ</sup></p>
            </div>
          </div>
          <div class="cartegory-right-bottom-item ">
            <img style="height: 70%;" src="img/female/1/product_5.jpg" alt="">
            <div>
              <a href="">Quần baggy nữ </a>
              <p>97.000<sup>đ</sup> - 150.000<sup>đ</sup></p>
            </div>
          </div>
          <div class="cartegory-right-bottom-item ">
            <img style="height: 70%;" src="img/female/1/product_6.jpg" alt="">
            <div>
              <a href="">Quần nỉ nữ thu đông</a>
              <p>110.000<sup></sup> - 150.000<sup>đ</sup></p>
            </div>
          </div>
          <div class="cartegory-right-bottom-item ">
            <img style="height: 70%;" src="img/female/1/product_7.jpg" alt="">
            <div>
              <a href="">Áo Mangto nữ</a>
              <p>110.000<sup></sup> - 150.000<sup>đ</sup></p>
            </div>
          </div>
          <div class="cartegory-right-bottom-item ">
            <img style="height: 70%;" src="img/female/1/product_8.jpg" alt="">
            <div>
              <a href="">Áo Cardigan nữ</a>
              <p>110.000<sup></sup> - 150.000<sup>đ</sup></p>
            </div>
          </div>
    ...
    <div class="cartegory-bottom">
      ...
      <button style="background-color: red;color: white;border-radius: 3px;">1</button>
      <button style="background-color: white"><a href="category-female_2.php" style="color: black;text-decoration: none;">2</a></button>
      <span style="background-color: white; margin-left: 10px;">...</span>
      <button style="background-color: white;"><a href="category-female_2.php" style="color: black; text-decoration: none;">&#10511;</a></button>
    </div>
  </div>
</section>
