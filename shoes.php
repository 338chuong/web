  ...
  <div class="cartegory">
    ...
    <div class="cartegory-left">
      <ul>
        ...
        <!-- <div class="cartegory-left-list">
          <li><a href="" class="cartegory-left-header">Tình Trạng</a>
            <ul>
              <li><a href="">Mới</a></li>
              <li><a href="">Đã Qua Sử Dụng</a></li>
            </ul>
          </li>
        </div>
        <div class="cartegory-left-list">
          <button><span>Xóa Tất Cả</span></button>
        </div> -->
      </ul>
    </div>
    <div class="cartegory-right">
        ...
        <div class="cartegory-right-bottom cartegory">
          <div class="cartegory-right-bottom-item">
            <img style="height: 70%;" src="img/shoes/1/balen_1.jpg" alt="">
            <div>
          ...
          <div class="cartegory-right-bottom-item">
            <img style="height: 70%;" src="img/shoes/1/MLB_1.jpg" alt="">
            <div>
          ...
          <div class="cartegory-right-bottom-item ">
            <img style="height: 70%;" src="img/shoes/1/MLB_2.jpg" alt="">
            <div>
          ...
          <div class="cartegory-right-bottom-item ">
            <img style="height: 70%;" src="img/shoes/1/gucci_1.jpg" alt="">
            <div>
          ...
          <div class="cartegory-right-bottom-item ">
            <img style="height: 70%;" src="img/shoes/1/Nike_1.jpg" alt="">
            <div>
          ...
          <div class="cartegory-right-bottom-item ">
            <img style="height: 70%;" src="img/shoes/1/Nike_2.jpg" alt="">
            <div>
          ...
          <div class="cartegory-right-bottom-item ">
            <img style="height: 70%;" src="img/shoes/1/off-white_1.jpg" alt="">
            <div>
          ...
          <div class="cartegory-right-bottom-item ">
            <img style="height: 70%;" src="img/shoes/1/off-white_2.jpg" alt="">
            <div>
    ...
    <div class="cartegory-bottom">
      ...
      <button style="background-color: white"><a href="shoes_2.php" style="color: black;text-decoration: none;">2</a></button>
      <span style="background-color: white; margin-left: 10px;">...</span>
      <button style="background-color: white;"><a href="shoes_2.php" style="color: black; text-decoration: none;">&#10511;</a></button>
    </div>
  </div>
</section>
