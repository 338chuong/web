...
<section>
  <div class="cartegory">
    ...
    <div class="cartegory-right">
        ...
        <div class="cartegory-right-bottom cartegory">
          <div class="cartegory-right-bottom-item ">
            <img src="img/a1.jfif" alt="">
            <div>
              <a href="">Dép chống trơn</a>
              <p>97.000<sup>đ</sup> - 150.000<sup>đ</sup></p>
            </div>
          </div>
          <div class="cartegory-right-bottom-item ">
            <img src="img/a11.jfif" alt="">
            <div>
              <a href="">Bộ quần áo ngắn tay</a>
              <p>110.000<sup></sup> - 150.000<sup>đ</sup></p>
            </div>
          </div>
          <div class="cartegory-right-bottom-item ">
            <img src="img/a12.jfif" alt="">
            <div>
              <a href="">Bộ quần áo thun</a>
              <p>110.000<sup></sup> - 150.000<sup>đ</sup></p>
            </div>
          </div>
          <div class="cartegory-right-bottom-item ">
            <img src="img/a13.jfif" alt="">
            <div>
    ...
    <div class="cartegory-bottom">
      ...
      <button style="background-color: white;"><a href="cartegory.php" style="color: black; text-decoration: none;">1</a></button>
