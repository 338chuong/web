...
<section>
  <div class="cartegory">
    ...
    <div class="cartegory-right">
        ...
        <div class="cartegory-right-bottom cartegory">
          <div class="cartegory-right-bottom-item" >
            <img style="height: 70%;" src="img/female/2/product_1.jpg" alt="">
            <div>
              <a href="">Áo khoác bomber nữ</a>
              <p>110.000<sup>đ</sup> - 150.000<sup>đ</sup></p>
            </div>
            </div>
          <div class="cartegory-right-bottom-item" >
            <img style="height: 70%;" src="img/female/2/product_2.jpg" alt="">
            <div>
              <a href="">Áo nỉ cardigan nữ </a>
              <p>14.000<sup>đ</sup> - 50.000<sup>đ</sup></p>
            </div>
          </div>
          <div class="cartegory-right-bottom-item " >
            <img style="height: 70%;" src="img/female/2/product_3.jpg" alt="">
            <div>
              <a href="">Áo nỉ dài tay </a>
              <p>129.000<sup>đ</sup><p>
            </div>
          </div>
          <div class="cartegory-right-bottom-item " >
            <img style="height: 70%;" src="img/female/2/product_4.jpg" alt="">
            <div>
              <a href="">Áo polo dài tay</a>
              <p>140.000<sup></sup> - 150.000<sup>đ</sup></p>
            </div>
          </div>
          <div class="cartegory-right-bottom-item ">
            <img style="height: 70%;" src="img/female/2/product_5.jpg" alt="">
            <div>
          ...
          <div class="cartegory-right-bottom-item ">
            <img style="height: 70%;" src="img/female/2/product_6.jpg" alt="">
            <div>
              <a href="">Áo len nữ </a>
          ...
          <div class="cartegory-right-bottom-item ">
            <img style="height: 70%;" src="img/female/2/product_7.jpg" alt="">
            <div>
          ...
          <div class="cartegory-right-bottom-item ">
            <img style="height: 70%;" src="img/female/2/product_8.jpg" alt="">
            <div>
    ...
    <div class="cartegory-bottom">
      <button style="background-color: white;"><a href="category-female.php" style="color: black; text-decoration: none;">&#10510;</a></button>
      <button style="background-color: white;"><a href="category-female.php" style="color: black;text-decoration: none;">1</a></button>
